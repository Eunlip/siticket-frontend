        ...
        <header>
          <div className="relative">
            <div className="flex items-center gap-1">
              ...
              <p className="font-semibold text-md xl:text-xl text-zinc-200/90">UNITED TRACTORS</p>
            </div>
            <p className="text-xs text-end absolute right-0 top-9 font-normal text-zinc-200">
              Member of <span className="text-secondary">ASTRA</span>
            </p>
          </div>
        </header>
                ...
                <ul className="mb-6 flex flex-col gap-1.5">
                  ...
                  <NavLink
                    ...
                    className={`group relative flex items-center gap-2.5 rounded-lg  py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4${
                      ...
                      'text-blue-300 bg-graydark  dark:bg-meta-4  rounded-lg'
                    }`}
                    onClick={() => setSidebarOpen(!sidebarOpen)}
                  >
                    <svg
                  ...
                  <li>
                    <NavLink
                      ...
                      className={`group relative flex items-center gap-2.5 rounded-lg py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                        ...
                        ' text-blue-200 bg-graydark dark:bg-meta-4 rounded-lg'
                      }`}
                      onClick={() => setSidebarOpen(!sidebarOpen)}
                    >
                      <svg
                    ...
                    {(handleClick, open) => {
                      return (
                        <>
                          ...
                          {/* <!-- Dropdown Menu Start --> */}
                          <div
                            className={`translate transform overflow-hidden bg-white/10 rounded-lg mx-4 mt-2 ${
                              !open && 'hidden'
                            }`}
                          >
                            <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                              <li>
                                <NavLink
                                  to="/users/input-user"
                                  className={({ isActive }) =>
                                    'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-blue-100 ' +
