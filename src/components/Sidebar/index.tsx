...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-[#ffffff] transition ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
        ...
        <header>
          <div className="relative">
            <div className="flex items-center gap-1 space-x-2">
              ...
              <p className="font-semibold text-md xl:text-xl dark:text-zinc-200/90 text-black">
                UNITED TRACTORS
              </p>
            </div>
            <p className="text-xs text-end absolute right-0 top-9 font-normal text-black dark:text-zinc-200">
              Member of{' '}
              <span className="text-blue-700 font-semibold">ASTRA</span>
            </p>
          </div>
        </header>
                            ...
                            <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                              <li>
                                <NavLink
                                  to="/users/data-users"
                                  className={({ isActive }) =>
                                    'group relative flex items-center gap-2.5 rounded-md px-4 font-medium dark:text-bodydark2 duration-300 ease-in-out dark:hover:text-blue-100 ' +
                                    (isActive &&
                                      'text-primary dark:text-bodydark1')
                                  }
                                  onClick={() => setSidebarOpen(!sidebarOpen)}
                                >
                                  Data Users
