...
const Guest: React.FC = () => {
  return (
    <>
      ...
      <div className="mt-5 space-y-5 dark:bg-boxdark sm:container min-w-full shadow bg-neutral-50 shadow-neutral-300 dark:shadow-neutral-700 rounded-md py-10">
        <h1 className="text-boxdark px-5 text-center sm:text-start dark:text-bodydark1 text-2xl font-semibold">
